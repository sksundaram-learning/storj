...
func (obj *postgresImpl) Get_Rollup_By_NodeId(ctx context.Context,
	rollup_node_id Rollup_NodeId_Field) (
	rollup *Rollup, err error) {
...
func (obj *postgresImpl) Update_Rollup_By_NodeId(ctx context.Context,
	rollup_node_id Rollup_NodeId_Field,
...
func (obj *sqlite3Impl) Get_Rollup_By_NodeId(ctx context.Context,
	rollup_node_id Rollup_NodeId_Field) (
	rollup *Rollup, err error) {
...
func (obj *sqlite3Impl) Update_Rollup_By_NodeId(ctx context.Context,
	rollup_node_id Rollup_NodeId_Field,
	update Rollup_Update_Fields) (
	rollup *Rollup, err error) {
	var __sets = &__sqlbundle_Hole{}
...
func (rx *Rx) Delete_Raw_By_NodeId(ctx context.Context,
	raw_node_id Raw_NodeId_Field) (
	deleted bool, err error) {
	var tx *Tx
	if tx, err = rx.getTx(ctx); err != nil {
...
func (rx *Rx) Get_Raw_By_NodeId(ctx context.Context,
	raw_node_id Raw_NodeId_Field) (
	raw *Raw, err error) {
	var tx *Tx
	if tx, err = rx.getTx(ctx); err != nil {
...
type Methods interface {
	...
	Delete_Raw_By_NodeId(ctx context.Context,
		raw_node_id Raw_NodeId_Field) (
		deleted bool, err error)
	...
	Get_Raw_By_NodeId(ctx context.Context,
		raw_node_id Raw_NodeId_Field) (
		raw *Raw, err error)
	...
	Update_Rollup_By_NodeId(ctx context.Context,
		rollup_node_id Rollup_NodeId_Field,
		update Rollup_Update_Fields) (
		rollup *Rollup, err error)
}
